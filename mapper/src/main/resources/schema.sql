...
insert into t_role (id, name, description) values (1, '超级管理员', '拥有系统的最高权限');
insert into t_role (id, name, description) values (2, '普通管理员', '拥有系统的日常管理权限');
insert into t_role (id, name, description) values (3, '超级会员', '拥有系统的最高用户权限');
insert into t_role (id, name, description) values (4, '普通会员', '拥有系统的普通会员权限');
